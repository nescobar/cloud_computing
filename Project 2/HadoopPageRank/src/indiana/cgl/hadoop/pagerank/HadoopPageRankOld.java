...
public class HadoopPageRankOld extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		...
		job1.setJarByClass(HadoopPageRankOld.class);
		...
		for (int i=0;i<noIterations;i++){
			...
			//config.setInt("numUrls", numUrls);
			job2.setJarByClass(HadoopPageRankOld.class);
		...
		job3.setJarByClass(HadoopPageRankOld.class);
